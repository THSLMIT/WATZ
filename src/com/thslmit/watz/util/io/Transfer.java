...
import com.thslmit.watz.util.type.CompactCalendar;

public class Transfer {

	private static final Preferences pref = Preferences.userNodeForPackage(Transfer.class);
	private static final Logger log = Logger.getLogger(Transfer.class.getName());
	
	private static final String ISO_LATIN1_ENCODING = "ISO-8859-1";
    ...
    public static XMLGregorianCalendar formatTime(CompactCalendar time) {
       return formatTime(time, pref.getBoolean("reduceTimeToSecondPrecision", false));
    }
